...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (target === "all" || target === "apk") {
            ...
            yield buildApk(flutterPath, targetPlatform, buildName, buildNumber, debugMode, buildFlavour, entryPoint, dartDefine);
        }
...
function buildApk(flutter, targetPlatform, buildName, buildNumber, debugMode, buildFlavour, entryPoint, dartDefine) {
    return __awaiter(this, void 0, void 0, function* () {
        var args = [
            "build",
            "apk"
